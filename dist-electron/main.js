...
(function(e, t) {
  ...
  function Df(p, w, O, F, Q, H) {
    ...
    if (!(O & i)) {
      var xe = Fe && Ke.call(p, "__wrapped__"), Le = je && Ke.call(w, "__wrapped__");
      if (xe || Le) {
...
function Hu() {
  return Xn.getFocusedWindow() ?? Ue ?? void 0;
}
...
function Yu() {
  ...
  }), Ue.setMenuBarVisibility(!1), Ue.webContents.on("did-finish-load", () => {
    Ue == null || Ue.webContents.send("main-process-message", (/* @__PURE__ */ new Date()).toLocaleString()), Ue && oo(Ue);
  }), Sa ? Ue.loadURL(Sa) : Ue.loadFile(Me.join(ju, "index.html"));
}
...
pt.on("window-all-closed", () => {
  process.platform !== "darwin" && (pt.quit(), Ue = null);
});
pt.on("activate", () => {
