import kt, { ipcMain as Gr, dialog as Ln, app as pt, BrowserWindow as Xn } from "electron";
import _t from "fs";
...
import Rl from "zlib";
import Qf from "http";
import { fileURLToPath as Zf } from "node:url";
import ke from "node:path";
import { writeFile as Ol, mkdir as Pl, access as ed } from "node:fs/promises";
import { constants as td } from "node:fs";
var Se = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Ue = {}, Bt = {}, Re = {};
...
var ct = Jf, rd = process.cwd, Dn = null, nd = process.env.GRACEFUL_FS_PLATFORM || process.platform;
process.cwd = function() {
  return Dn || (Dn = rd.call(process)), Dn;
};
try {
  process.cwd();
} catch {
...
function ad(e) {
  ...
  }), nd === "win32" && (e.rename = typeof e.rename != "function" ? e.rename : function(c) {
    function f(d, g, v) {
      var y = Date.now(), A = 0;
      c(d, g, function S(T) {
...
var te = _t, fd = id, dd = od, hd = ld, mn = Ca, ge, Un;
...
function ba(e) {
  fd(e), e.gracefulify = ba, e.createReadStream = Z, e.createWriteStream = ae;
  var t = e.readFile;
  e.readFile = r;
  function r(E, q, B) {
...
const Ed = Re.fromPromise, { makeDir: yd, makeDirSync: Oi } = Oa, Pi = Ed(yd);
var Ze = {
  mkdirs: Pi,
  mkdirsSync: Oi,
  // alias
...
function Rd(e, t, r, n) {
  const { srcStat: i, destStat: a } = Cd(e, t, n);
  if (a) {
    if (Yr(i, a)) {
...
const Ne = Oe, Pr = re, Od = Ze.mkdirs, Pd = jt.pathExists, Id = Ll.utimesMillis, Ir = cr;
function Nd(e, t, r, n) {
...
function kn(e, t, r, n, i) {
  (n.dereference ? Ne.stat : Ne.lstat)(t, (o, s) => o ? i(o) : s.isDirectory() ? Md(s, e, t, r, n, i) : s.isFile() || s.isCharacterDevice() || s.isBlockDevice() ? $d(s, e, t, r, n, i) : s.isSymbolicLink() ? Hd(e, t, r, n, i) : s.isSocket() ? i(new Error(`Cannot copy a socket file: ${t}`)) : s.isFIFO() ? i(new Error(`Cannot copy a FIFO pipe: ${t}`)) : i(new Error(`Unknown file: ${t}`)));
}
function $d(e, t, r, n, i, a) {
  return t ? Fd(e, r, n, i, a) : Bl(e, r, n, i, a);
}
...
function Bl(e, t, r, n, i) {
  Ne.copyFile(t, r, (a) => a ? i(a) : n.preserveTimestamps ? xd(e.mode, t, r, i) : Zn(r, e.mode, i));
}
function xd(e, t, r, n) {
  return Ld(e) ? Ud(r, e, (i) => i ? n(i) : Io(e, t, r, n)) : Io(e, t, r, n);
}
function Ld(e) {
  return (e & 128) === 0;
}
...
function Io(e, t, r, n) {
  kd(t, r, (i) => i ? n(i) : Zn(r, e, n));
}
function Zn(e, t, r) {
  return Ne.chmod(e, t, r);
}
function kd(e, t, r) {
  Ne.stat(e, (n, i) => n ? r(n) : Id(t, i.atime, i.mtime, r));
}
function Md(e, t, r, n, i, a) {
  return t ? jl(r, n, i, a) : Bd(e.mode, r, n, i, a);
}
function Bd(e, t, r, n, i) {
  Ne.mkdir(r, (a) => {
    if (a) return i(a);
...
function jd(e, t, r, n, i, a) {
  ...
  Ir.checkPaths(o, s, "copy", i, (l, m) => {
    if (l) return a(l);
    const { destStat: c } = m;
    Dd(c, o, s, i, (f) => f ? a(f) : Hl(e, r, n, i, a));
  });
}
function Hd(e, t, r, n, i) {
  Ne.readlink(t, (a, o) => {
    ...
    if (n.dereference && (o = Pr.resolve(process.cwd(), o)), e)
      Ne.readlink(r, (s, l) => s ? s.code === "EINVAL" || s.code === "UNKNOWN" ? Ne.symlink(o, r, i) : i(s) : (n.dereference && (l = Pr.resolve(process.cwd(), l)), Ir.isSrcSubdir(o, l) ? i(new Error(`Cannot copy '${o}' to a subdirectory of itself, '${l}'.`)) : e.isDirectory() && Ir.isSrcSubdir(l, o) ? i(new Error(`Cannot overwrite '${l}' with '${o}'.`)) : qd(o, r, i)));
    else
...
var Gd = Nd;
const we = Oe, Nr = re, Vd = Ze.mkdirsSync, Wd = Ll.utimesMillisSync, Dr = cr;
function Yd(e, t, r) {
  ...
  return Dr.checkParentPathsSync(e, n, t, "copy"), zd(i, e, t, r);
}
function zd(e, t, r, n) {
  if (n.filter && !n.filter(t, r)) return;
  const i = Nr.dirname(r);
  return we.existsSync(i) || Vd(i), ql(e, t, r, n);
}
function Xd(e, t, r, n) {
...
function ql(e, t, r, n) {
  ...
  if (a.isFile() || a.isCharacterDevice() || a.isBlockDevice()) return Kd(a, e, t, r, n);
  if (a.isSymbolicLink()) return ah(e, t, r, n);
...
function Kd(e, t, r, n, i) {
  return t ? Jd(e, r, n, i) : Gl(e, r, n, i);
}
function Jd(e, t, r, n) {
  if (n.overwrite)
...
function Gl(e, t, r, n) {
  return we.copyFileSync(t, r), n.preserveTimestamps && Qd(e.mode, t, r), Ia(r, e.mode);
}
function Qd(e, t, r) {
  return Zd(e) && eh(r, e), th(t, r);
}
function Zd(e) {
  return (e & 128) === 0;
}
...
function rh(e, t, r, n, i) {
  return t ? Vl(r, n, i) : nh(e.mode, r, n, i);
}
function nh(e, t, r, n) {
  return we.mkdirSync(r), Vl(t, r, n), Ia(r, e);
}
function Vl(e, t, r) {
  we.readdirSync(e).forEach((n) => ih(n, e, t, r));
}
function ih(e, t, r, n) {
...
var fh = Da;
Da.sync = zl;
const Mn = Oe, dh = Re.fromCallback, Xl = fh;
function hh(e, t) {
...
const mh = Re.fromPromise, Kl = Bt, Jl = re, Ql = Ze, Zl = ei, xo = mh(async function(t) {
  let r;
  try {
...
const Eh = Re.fromCallback, ec = re, dt = Oe, tc = Ze;
function yh(e, t) {
  function r() {
    dt.writeFile(e, "", (n) => {
      if (n) return t(n);
...
const _h = Re.fromCallback, rc = re, ft = Oe, nc = Ze, Ah = jt.pathExists, { areIdentical: ic } = cr;
function Th(e, t, r) {
  function n(i, a) {
    ft.link(i, a, (o) => {
      if (o) return r(o);
...
const ht = re, Cr = Oe, bh = jt.pathExists;
function Rh(e, t, r) {
  if (ht.isAbsolute(e))
    ...
    }));
  {
    ...
    return bh(i, (a, o) => a ? r(a) : o ? r(null, {
      toCwd: i,
      toDst: e
...
const $h = Re.fromCallback, oc = re, Ge = Bt, sc = Ze, Fh = sc.mkdirs, xh = sc.mkdirsSync, lc = Ph, Lh = lc.symlinkPaths, Uh = lc.symlinkPathsSync, cc = Dh, kh = cc.symlinkType, Mh = cc.symlinkTypeSync, Bh = jt.pathExists, { areIdentical: uc } = cr;
function jh(e, t, r, n) {
...
function Hh(e, t, r) {
  ...
  return Ge.existsSync(a) || xh(a), Ge.symlinkSync(e, t, r);
}
var qh = {
  createSymlink: $h(jh),
  createSymlinkSync: Hh
};
const { createFile: ko, createFileSync: Mo } = wh, { createLink: Bo, createLinkSync: jo } = Ch, { createSymlink: Ho, createSymlinkSync: qo } = qh;
var Gh = {
  // file
  createFile: ko,
  createFileSync: Mo,
...
var $a = { stringify: Vh, stripBom: Wh };
let or;
try {
  or = Oe;
} catch {
...
const tp = Re.fromCallback, br = Oe, hc = re, pc = Ze, rp = jt.pathExists;
function np(e, t, r, n) {
...
const { stringify: ap } = $a, { outputFile: op } = Fa;
async function sp(e, t, r = {}) {
  const n = ap(t, r);
  await op(e, n, r);
}
var lp = sp;
const { stringify: cp } = $a, { outputFileSync: up } = Fa;
function fp(e, t, r) {
  const n = cp(t, r);
  up(e, n, r);
}
var dp = fp;
const hp = Re.fromPromise, be = ep;
be.outputJson = hp(lp);
be.outputJsonSync = dp;
...
var pp = be;
const mp = Oe, la = re, gp = Na.copy, mc = ei.remove, Ep = Ze.mkdirp, yp = jt.pathExists, Go = cr;
function vp(e, t, r, n) {
  ...
  Go.checkPaths(e, t, "move", r, (a, o) => {
    ...
    Go.checkParentPaths(e, s, t, "move", (m) => {
      if (m) return n(m);
      if (wp(t)) return Vo(e, t, i, l, n);
      Ep(la.dirname(t), (c) => c ? n(c) : Vo(e, t, i, l, n));
    });
  });
}
function wp(e) {
...
function Vo(e, t, r, n, i) {
  ...
  yp(t, (a, o) => a ? i(a) : o ? i(new Error("dest already exists.")) : Ii(e, t, r, i));
}
function Ii(e, t, r, n) {
  mp.rename(e, t, (i) => i ? i.code !== "EXDEV" ? n(i) : _p(e, t, r, n) : n());
}
function _p(e, t, r, n) {
  gp(e, t, {
    overwrite: r,
...
var Ap = vp;
const gc = Oe, ca = re, Tp = Na.copySync, Ec = ei.removeSync, Sp = Ze.mkdirpSync, Wo = cr;
function Cp(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: a = !1 } = Wo.checkPathsSync(e, t, "move", r);
  return Wo.checkParentPathsSync(e, i, t, "move"), bp(t) || Sp(ca.dirname(t)), Rp(e, t, n, a);
}
function bp(e) {
...
function yc() {
  ...
  zo = 1;
  function e(t) {
    n.debug = n, n.default = n, n.coerce = m, n.disable = s, n.enable = a, n.enabled = l, n.humanize = xp(), n.destroy = c, Object.keys(t).forEach((f) => {
      n[f] = t[f];
...
function kp() {
  if (Jo) return xi;
  Jo = 1;
  const e = Jn, t = bl, r = Up(), { env: n } = process;
  let i;
...
typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? fa.exports = Lp() : fa.exports = Mp();
var Bp = fa.exports, zr = {};
...
zr.ProgressCallbackTransform = Hp;
...
const qp = Wr, Gp = Bp, Vp = _t, Wp = Vr, da = At, Yp = Et, Zo = ur, zp = zr, It = (0, Gp.default)("electron-builder");
...
class xa extends Error {
  constructor(t, r = `HTTP error: ${Xp.get(t) || t}`, n = null) {
...
`));
  ...
  doDownload(t, r, n) {
    const i = this.createRequest(t, (a) => {
      ...
      r.responseHandler == null ? Qp(r, a) : r.responseHandler(a, r.callback);
    });
...
class pa extends Wp.Transform {
  // noinspection JSUnusedGlobalSymbols
  get actual() {
    return this._actual;
  }
  constructor(t, r = "sha512", n = "base64") {
    super(), this.expected = t, this.algorithm = r, this.encoding = n, this._actual = null, this.isValidateOnEnd = !0, this.digester = (0, qp.createHash)(r);
  }
  // noinspection JSUnusedGlobalSymbols
  _transform(t, r, n) {
...
function Qp(e, t) {
  if (!Jp(ir(t, "X-Checksum-Sha2"), e.options.sha2, e.callback))
    return;
  const r = [];
  if (e.options.onProgress != null) {
    const o = ir(t, "content-length");
    o != null && r.push(new zp.ProgressCallbackTransform(parseInt(o, 10), e.options.cancellationToken, e.options.onProgress));
  }
...
Xr.githubUrl = em;
Xr.githubTagPrefix = tm;
Xr.getS3LikeProviderBaseUrl = rm;
...
async function Tc(e, t) {
  var r;
  const { retries: n, interval: i, backoff: a = 0, attempt: o = 0, shouldRetry: s, cancellationToken: l = new am.CancellationToken() } = t;
  try {
    return await e();
  } catch (m) {
...
const Sc = Wr, Cc = ur, sm = "options.name must be either a string or a Buffer", es = (0, Sc.randomBytes)(16);
es[0] = es[0] | 1;
const xn = {}, V = [];
for (let e = 0; e < 256; e++) {
...
class Mt {
  ...
  static v5(t, r) {
    return lm(t, "sha1", 80, r);
  }
  toString() {
    return this.ascii == null && (this.ascii = cm(this.binary)), this.ascii;
  }
  inspect() {
...
function lm(e, t, r, n, i = Rr.ASCII) {
  const a = (0, Sc.createHash)(t);
  if (typeof e != "string" && !Buffer.isBuffer(e))
    throw (0, Cc.newError)(sm, "ERR_INVALID_UUID_NAME");
    ...
    function G(h, u) {
      if (h.opt.xmlns) {
        ...
        for (var J = 0, ne = h.attribList.length; J < ne; J++) {
          var he = h.attribList[J], ye = he[0], at = he[1], le = I(ye, !0), Me = le.prefix, wi = le.local, an = Me === "" ? "" : C.ns[Me] || "", pr = {
            name: ye,
            value: at,
            prefix: Me,
            local: wi,
          ...
          ), pr.uri = Me), h.tag.attributes[ye] = pr, M(h, "onattribute", pr);
        }
...
function Sm(e, t) {
  if (t = t || {}, Object.keys(t).forEach(function(r) {
    ...
    return r;
  }, this.instanceOf = t.instanceOf || null, this.predicate = t.predicate || null, this.represent = t.represent || null, this.representName = t.representName || null, this.defaultStyle = t.defaultStyle || null, this.multi = t.multi || !1, this.styleAliases = Tm(t.styleAliases || null), Am.indexOf(this.kind) === -1)
    throw new ns('Unknown kind "' + this.kind + '" is specified for "' + e + '" YAML type.');
}
var Pe = Sm, vr = Jr, ki = Pe;
function is(e, t) {
  var r = [];
...
ma.prototype.extend = function(t) {
  ...
  return i.implicit = (this.implicit || []).concat(r), i.explicit = (this.explicit || []).concat(n), i.compiledImplicit = is(i, "implicit"), i.compiledExplicit = is(i, "explicit"), i.compiledTypeMap = Cm(i.compiledImplicit, i.compiledExplicit), i;
};
var Ic = ma, bm = Pe, Nc = new bm("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: function(e) {
    return e !== null ? e : "";
  }
}), Rm = Pe, Dc = new Rm("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: function(e) {
    return e !== null ? e : [];
  }
}), Om = Pe, $c = new Om("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: function(e) {
    return e !== null ? e : {};
  }
...
var xc = new Im("tag:yaml.org,2002:null", {
  kind: "scalar",
  resolve: Nm,
  construct: Dm,
  predicate: $m,
...
var Lc = new Fm("tag:yaml.org,2002:bool", {
  kind: "scalar",
  resolve: xm,
  construct: Lm,
  predicate: Um,
...
function Vm(e) {
  return Object.prototype.toString.call(e) === "[object Number]" && e % 1 === 0 && !km.isNegativeZero(e);
}
var Uc = new Mm("tag:yaml.org,2002:int", {
  kind: "scalar",
  resolve: qm,
  construct: Gm,
  predicate: Vm,
...
function Jm(e, t) {
  ...
  if (isNaN(e))
    ...
    return "-0.0";
  return r = e.toString(10), Km.test(r) ? r.replace("e", ".e") : r;
}
function Qm(e) {
  return Object.prototype.toString.call(e) === "[object Number]" && (e % 1 !== 0 || kc.isNegativeZero(e));
}
var Mc = new Wm("tag:yaml.org,2002:float", {
  kind: "scalar",
  resolve: zm,
  construct: Xm,
  predicate: Qm,
...
var Gc = new Zm("tag:yaml.org,2002:timestamp", {
  kind: "scalar",
  resolve: eg,
  construct: tg,
  instanceOf: Date,
...
var Vc = new ng("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: ig
}), ag = Pe, Ba = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;
function og(e) {
  if (e === null) return !1;
...
var Wc = new ag("tag:yaml.org,2002:binary", {
  kind: "scalar",
  resolve: og,
  construct: sg,
  predicate: cg,
  represent: lg
}), ug = Pe, fg = Object.prototype.hasOwnProperty, dg = Object.prototype.toString;
function hg(e) {
  if (e === null) return !0;
  var t = [], r, n, i, a, o, s = e;
  for (r = 0, n = s.length; r < n; r += 1) {
    if (i = s[r], o = !1, dg.call(i) !== "[object Object]") return !1;
    for (a in i)
      if (fg.call(i, a))
        if (!o) o = !0;
        else return !1;
...
var Yc = new ug("tag:yaml.org,2002:omap", {
  kind: "sequence",
  resolve: hg,
  construct: pg
}), mg = Pe, gg = Object.prototype.toString;
function Eg(e) {
  if (e === null) return !0;
  var t, r, n, i, a, o = e;
  for (a = new Array(o.length), t = 0, r = o.length; t < r; t += 1) {
    if (n = o[t], gg.call(n) !== "[object Object]" || (i = Object.keys(n), i.length !== 1)) return !1;
    a[t] = [i[0], n[i[0]]];
  }
  return !0;
}
...
var zc = new mg("tag:yaml.org,2002:pairs", {
  kind: "sequence",
  resolve: Eg,
  construct: yg
}), vg = Pe, wg = Object.prototype.hasOwnProperty;
function _g(e) {
  if (e === null) return !0;
  var t, r = e;
  for (t in r)
...
var Xc = new vg("tag:yaml.org,2002:set", {
  kind: "mapping",
  resolve: _g,
  construct: Ag
}), ja = jc.extend({
...
}), $t = Ve, Kc = Jr, Tg = wm, Sg = ja, yt = Object.prototype.hasOwnProperty, Hn = 1, Jc = 2, Qc = 3, qn = 4, Mi = 1, Cg = 2, as = 3, bg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Rg = /[\x85\u2028\u2029]/, Og = /[,\[\]\{\}]/, Zc = /^(?:!|!!|![a-z\-]+!)$/i, eu = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function os(e) {
...
function iu(e, t) {
  ...
  return r.snippet = Tg(r), new Kc(t, r);
}
function L(e, t) {
  throw iu(e, t);
}
...
function mt(e, t, r, n) {
  ...
  if (t < r) {
    ...
    else bg.test(s) && L(e, "the stream contains non-printable characters");
    e.result += s;
  }
}
function cs(e, t, r, n) {
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (s = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (s === 92) {
      if (mt(e, r, e.position, !0), s = e.input.charCodeAt(++e.position), Qe(s))
        ...
        for (i = o, a = 0; i > 0; i--)
          s = e.input.charCodeAt(++e.position), (o = Pg(s)) >= 0 ? a = (a << 4) + o : L(e, "expected hexadecimal character");
        e.result += Dg(a), e.position++;
      } else
...
function kg(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; f !== 0; )
    if (f = e.input.charCodeAt(++e.position), f === 43 || f === 45)
      Mi === i ? i = f === 43 ? as : Cg : L(e, "repeat of a chomping mode identifier");
    else if ((c = Ng(f)) >= 0)
...
function Bg(e) {
  ...
  if (e.tag !== null && L(e, "duplication of a tag property"), o = e.input.charCodeAt(++e.position), o === 60 ? (r = !0, o = e.input.charCodeAt(++e.position)) : o === 33 ? (n = !0, i = "!!", o = e.input.charCodeAt(++e.position)) : i = "!", t = e.position, r) {
    ...
    a = e.input.slice(t, e.position), Og.test(a) && L(e, "tag suffix cannot contain flow indicator characters");
  }
...
function lr(e, t, r, n, i) {
  ...
  if (s && (s = m || i), (l === 1 || qn === r) && (Hn === r || Jc === r ? y = t : y = t + 1, A = e.position - e.lineStart, l === 1 ? s && (us(e, A) || Mg(e, A, y)) || Ug(e, y) ? c = !0 : (o && kg(e, y) || xg(e, y) || Lg(e, y) ? c = !0 : Hg(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && L(e, "alias node should not have any properties")) : Fg(e, y, Hn === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = s && us(e, A))), e.tag === null)
...
function qg(e) {
  ...
  if (oe(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, oe(e, !0, -1)) : a && L(e, "directives end mark is expected"), lr(e, e.lineIndent - 1, qn, !1, !0), oe(e, !0, -1), e.checkLineBreaks && Rg.test(e.input.slice(t, e.position)) && Gn(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && ni(e)) {
...
Ma.loadAll = Gg;
Ma.load = Vg;
var ou = {}, ii = Ve, Qr = Jr, Wg = ja, su = Object.prototype.toString, lu = Object.prototype.hasOwnProperty, Ga = 65279, Yg = 9, xr = 10, zg = 13, Xg = 32, Kg = 33, Jg = 34, ga = 35, Qg = 37, Zg = 38, e0 = 39, t0 = 42, cu = 44, r0 = 45, Vn = 58, n0 = 61, i0 = 62, a0 = 63, o0 = 64, uu = 91, fu = 93, s0 = 96, du = 123, l0 = 124, hu = 125, _e = {};
_e[0] = "\\0";
_e[7] = "\\a";
_e[8] = "\\b";
_e[9] = "\\t";
...
var h0 = 1, Lr = 2;
function p0(e) {
  this.schema = e.schema || Wg, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || !1, this.skipInvalid = e.skipInvalid || !1, this.flowLevel = ii.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = f0(this.schema, e.styles || null), this.sortKeys = e.sortKeys || !1, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || !1, this.noCompatMode = e.noCompatMode || !1, this.condenseFlow = e.condenseFlow || !1, this.quotingType = e.quotingType === '"' ? Lr : h0, this.forceQuotes = e.forceQuotes || !1, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
function fs(e, t) {
...
function g0(e) {
  return Ur(e) && e !== Ga && !Wn(e) && e !== r0 && e !== a0 && e !== Vn && e !== cu && e !== uu && e !== fu && e !== du && e !== hu && e !== ga && e !== Zg && e !== t0 && e !== Kg && e !== l0 && e !== n0 && e !== i0 && e !== e0 && e !== Jg && e !== Qg && e !== o0 && e !== s0;
}
function E0(e) {
  return !Wn(e) && e !== Vn;
}
...
function y0(e, t, r, n, i, a, o, s) {
  var l, m = 0, c = null, f = !1, d = !1, g = n !== -1, v = -1, y = g0(Sr(e, 0)) && E0(Sr(e, e.length - 1));
  if (t || o)
...
function v0(e, t, r, n, i) {
  e.dump = function() {
    ...
    if (!e.noCompatMode && (c0.indexOf(t) !== -1 || u0.test(t)))
    ...
    switch (y0(
      ...
      case Eu:
        return ">" + ps(t, e.indent) + ms(fs(w0(t, o), a));
      case Kt:
        return '"' + _0(t) + '"';
      default:
...
function _0(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = Sr(e, i), n = _e[r], !n && Ur(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || d0(r);
  return t;
}
function A0(e, t, r) {
  var n = "", i = e.tag, a, o, s;
...
function it(e, t, r, n, i, a, o) {
  ...
  if (c && (f = e.duplicates.indexOf(r), d = f !== -1), (e.tag !== null && e.tag !== "?" || d || e.indent !== 2 && t > 0) && (i = !1), d && e.usedDuplicates[f])
    ...
    if (c && d && !e.usedDuplicates[f] && (e.usedDuplicates[f] = !0), s === "[object Object]")
      n && Object.keys(e.dump).length !== 0 ? (S0(e, t, e.dump, i), d && (e.dump = "&ref_" + f + e.dump)) : (T0(e, t, e.dump), d && (e.dump = "&ref_" + f + " " + e.dump));
    else if (s === "[object Array]")
      n && e.dump.length !== 0 ? (e.noArrayIndent && !o && t > 0 ? Es(e, t - 1, e.dump, i) : Es(e, t, e.dump, i), d && (e.dump = "&ref_" + f + e.dump)) : (A0(e, t, e.dump), d && (e.dump = "&ref_" + f + " " + e.dump));
    else if (s === "[object String]")
      e.tag !== "?" && v0(e, e.dump, t, a, l);
    else {
...
ai.Lazy = O0;
var wa = { exports: {} };
const P0 = "2.0.0", vu = 256, I0 = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
9007199254740991, N0 = 16, D0 = vu - 6, $0 = [
  "major",
  "premajor",
  "minor",
  "preminor",
...
var oi = {
  MAX_LENGTH: vu,
  MAX_SAFE_COMPONENT_LENGTH: N0,
  MAX_SAFE_BUILD_LENGTH: D0,
  MAX_SAFE_INTEGER: I0,
  RELEASE_TYPES: $0,
  SEMVER_SPEC_VERSION: P0,
...
var Zr = wa.exports;
const x0 = Object.freeze({ loose: !0 }), L0 = Object.freeze({}), U0 = (e) => e ? typeof e != "object" ? x0 : e : L0;
var Wa = U0;
const vs = /^[0-9]+$/, wu = (e, t) => {
...
const _n = si, { MAX_LENGTH: ws, MAX_SAFE_INTEGER: An } = oi, { safeRe: Tn, t: Sn } = Zr, M0 = Wa, { compareIdentifiers: Bi } = _u;
let B0 = class Je {
  constructor(t, r) {
    if (r = M0(r), t instanceof Je) {
...
var J0 = K0;
const Q0 = Ie, Z0 = (e, t) => new Q0(e, t).major;
var eE = Z0;
const tE = Ie, rE = (e, t) => new tE(e, t).minor;
var nE = rE;
const iE = Ie, aE = (e, t) => new iE(e, t).patch;
var oE = aE;
const sE = fr, lE = (e, t) => {
  const r = sE(e, t);
...
var cE = lE;
const Ss = Ie, uE = (e, t, r) => new Ss(e, r).compare(new Ss(t, r));
var We = uE;
const fE = We, dE = (e, t, r) => fE(t, e, r);
var hE = dE;
const pE = We, mE = (e, t) => pE(e, t, !0);
var gE = mE;
const Cs = Ie, EE = (e, t, r) => {
  const n = new Cs(e, r), i = new Cs(t, r);
  return n.compare(i) || n.compareBuild(i);
};
var Ya = EE;
const yE = Ya, vE = (e, t) => e.sort((r, n) => yE(r, n, t));
var wE = vE;
const _E = Ya, AE = (e, t) => e.sort((r, n) => _E(n, r, t));
var TE = AE;
const SE = We, CE = (e, t, r) => SE(e, t, r) > 0;
var li = CE;
const bE = We, RE = (e, t, r) => bE(e, t, r) < 0;
var za = RE;
const OE = We, PE = (e, t, r) => OE(e, t, r) === 0;
var Au = PE;
const IE = We, NE = (e, t, r) => IE(e, t, r) !== 0;
var Tu = NE;
const DE = We, $E = (e, t, r) => DE(e, t, r) >= 0;
var Xa = $E;
const FE = We, xE = (e, t, r) => FE(e, t, r) <= 0;
var Ka = xE;
const LE = Au, UE = Tu, kE = li, ME = Xa, BE = za, jE = Ka, HE = (e, t, r, n) => {
  switch (t) {
    case "===":
...
var Su = HE;
const qE = Ie, GE = fr, { safeRe: Cn, t: bn } = Zr, VE = (e, t) => {
  if (e instanceof qE)
    return e;
...
function Ye() {
  ...
  ji = t;
  const r = zE, n = new r(), i = Wa, a = ci(), o = si, s = Ie, {
    safeRe: l,
    t: m,
...
var ui = KE;
const JE = Ye(), QE = (e, t) => new JE(e, t).set.map((r) => r.map((n) => n.value).join(" ").trim().split(" "));
var ZE = QE;
const ey = Ie, ty = Ye(), ry = (e, t, r) => {
  ...
  return e.forEach((o) => {
    a.test(o) && (!n || i.compare(o) === -1) && (n = o, i = new ey(n, r));
  }), n;
};
var ny = ry;
const iy = Ie, ay = Ye(), oy = (e, t, r) => {
  let n = null, i = null, a = null;
  try {
    a = new ay(t, r);
  } catch {
  ...
  return e.forEach((o) => {
    a.test(o) && (!n || i.compare(o) === 1) && (n = o, i = new iy(n, r));
  }), n;
};
var sy = oy;
const qi = Ie, ly = Ye(), Os = li, cy = (e, t) => {
  e = new ly(e, t);
  let r = new qi("0.0.0");
...
const fy = Ye(), dy = (e, t) => {
  try {
    return new fy(e, t).range || "*";
  } catch {
    return null;
  }
};
var hy = dy;
const py = Ie, Cu = ci(), { ANY: my } = Cu, gy = Ye(), Ey = ui, Ps = li, Is = za, yy = Ka, vy = Xa, wy = (e, t, r, n) => {
  e = new py(e, n), t = new gy(t, n);
  let i, a, o, s, l;
  switch (r) {
    case ">":
      i = Ps, a = yy, o = Is, s = ">", l = ">=";
  ...
  for (let m = 0; m < t.set.length; ++m) {
    ...
    let f = null, d = null;
    if (c.forEach((g) => {
      g.semver === my && (g = new Cu(">=0.0.0")), f = f || g, d = d || g, i(g.semver, f.semver, n) ? f = g : o(g.semver, d.semver, n) && (d = g);
...
var Ja = wy;
const _y = Ja, Ay = (e, t, r) => _y(e, t, ">", r);
var Ty = Ay;
const Sy = Ja, Cy = (e, t, r) => Sy(e, t, "<", r);
var by = Cy;
const Ns = Ye(), Ry = (e, t, r) => (e = new Ns(e, r), t = new Ns(t, r), e.intersects(t, r));
var Oy = Ry;
const Py = ui, Iy = We;
var Ny = (e, t, r) => {
  const n = [];
  let i = null, a = null;
  const o = e.sort((c, f) => Iy(c, f, r));
  for (const c of o)
    Py(c, t, r) ? (a = c, i || (i = c)) : (a && n.push([i, a]), a = null, i = null);
  i && n.push([i, null]);
  const s = [];
  for (const [c, f] of n)
...
const Ds = Ye(), Qa = ci(), { ANY: Gi } = Qa, wr = ui, Za = We, Dy = (e, t, r = {}) => {
  if (e === t)
    return !0;
  ...
  return !0;
}, $y = [new Qa(">=0.0.0-0")], $s = [new Qa(">=0.0.0")], Fy = (e, t, r) => {
  if (e === t)
    return !0;
  if (e.length === 1 && e[0].semver === Gi) {
    if (t.length === 1 && t[0].semver === Gi)
      return !0;
    r.includePrerelease ? e = $y : e = $s;
  }
  if (t.length === 1 && t[0].semver === Gi) {
...
var xy = Dy;
const Vi = Zr, Ls = oi, Ly = Ie, Us = _u, Uy = fr, ky = G0, My = Y0, By = X0, jy = J0, Hy = eE, qy = nE, Gy = oE, Vy = cE, Wy = We, Yy = hE, zy = gE, Xy = Ya, Ky = wE, Jy = TE, Qy = li, Zy = za, ev = Au, tv = Tu, rv = Xa, nv = Ka, iv = Su, av = WE, ov = ci(), sv = Ye(), lv = ui, cv = ZE, uv = ny, fv = sy, dv = uy, hv = hy, pv = Ja, mv = Ty, gv = by, Ev = Oy, yv = Ny, vv = xy;
var bu = {
  parse: Uy,
  valid: ky,
  clean: My,
...
(function(e, t) {
  ...
  function If(p, w) {
    var O = dn(p), F = !O && Vf(p), Q = !O && !F && Ri(p), H = !O && !F && !Q && So(p), ie = O || F || Q || H, fe = ie ? Me(p.length, String) : [], pe = fe.length;
    for (var ee in p)
  ...
  function Df(p, w, O, F, Q, H) {
    ...
    if (!(O & i)) {
      var xe = Fe && Ke.call(p, "__wrapped__"), Le = Be && Ke.call(w, "__wrapped__");
      if (xe || Le) {
        var lt = xe ? p.value() : p, tt = Le ? w.value() : w;
  ...
  function yo(p, w, O, F, Q, H) {
    ...
    if (ee && H.get(w))
      return ee == w;
    var Fe = -1, Be = !0, ve = O & a ? new cn() : void 0;
    for (H.set(p, w), H.set(w, p); ++Fe < fe; ) {
      var xe = p[Fe], Le = w[Fe];
      if (F)
        var lt = ie ? F(Le, xe, Fe, w, p, H) : F(xe, Le, Fe, p, w, H);
      if (lt !== void 0) {
        if (lt)
          continue;
        Be = !1;
      ...
      if (ve) {
        if (!le(w, function(tt, Pt) {
          if (!an(ve, Pt) && (xe === tt || Q(xe, tt, O, F, H)))
            return ve.push(Pt);
        })) {
          Be = !1;
          break;
        }
      } else if (!(xe === Le || Q(xe, Le, O, F, H))) {
        Be = !1;
        break;
      }
    }
    return H.delete(p), H.delete(w), Be;
  }
  ...
  function Uf(p, w, O, F, Q, H) {
    ...
    if (Le && !lt) {
      ...
      hn != pn && "constructor" in p && "constructor" in w && !(typeof hn == "function" && hn instanceof hn && typeof pn == "function" && pn instanceof pn) && (Le = !1);
    }
    return H.delete(p), H.delete(w), Le;
  }
  function vo(p) {
    return Nf(p, zf, Mf);
  }
...
en.createTempUpdateFile = Cv;
const _v = Wr, Av = _t, ks = wv, Nt = Tt, Or = re;
class Tv {
  constructor(t) {
...
en.DownloadedUpdateHelper = Tv;
function Sv(e, t = "sha512", r = "base64", n) {
  return new Promise((i, a) => {
    const o = (0, _v.createHash)(t);
    o.on("error", a).setEncoding(r), (0, Av.createReadStream)(e, {
      ...n,
...
eo.getAppCacheDir = Rv;
const Wi = re, bv = Jn;
function Rv() {
  const e = (0, bv.homedir)();
  let t;
...
ze.newBaseUrl = Iv;
ze.newUrlFromBase = Nv;
ze.getChannelFilename = Dv;
const Ou = At;
function Iv(e) {
...
var se = {}, $v = "[object Symbol]", Pu = /[\\^$.*+?()[\]{}|]/g, Fv = RegExp(Pu.source), xv = typeof Se == "object" && Se && Se.Object === Object && Se, Lv = typeof self == "object" && self && self.Object === Object && self, Uv = xv || Lv || Function("return this")(), kv = Object.prototype, Mv = kv.toString, Bs = Uv.Symbol, js = Bs ? Bs.prototype : void 0, Hs = js ? js.toString : void 0;
function Bv(e) {
  if (typeof e == "string")
    return e;
  if (Hv(e))
...
function Hv(e) {
  return typeof e == "symbol" || jv(e) && Mv.call(e) == $v;
}
function qv(e) {
  return e == null ? "" : Bv(e);
}
function Gv(e) {
  return e = qv(e), e && Fv.test(e) ? e.replace(Pu, "\\$&") : e;
}
var Iu = Gv;
Object.defineProperty(se, "__esModule", { value: !0 });
se.Provider = void 0;
se.findFile = Xv;
se.parseUpdateInfo = Kv;
se.getFileList = Nu;
se.resolveFiles = Jv;
const vt = ce, Vv = Ee, Wv = At, zn = ze, Yv = Iu;
class zv {
  constructor(t) {
  ...
  getBlockMapFiles(t, r, n, i = null) {
    ...
    return [(0, zn.newUrlFromBase)(`${t.pathname.replace(new RegExp(Yv(n), "g"), r)}.blockmap`, i ? new Wv.URL(i) : t), a];
  }
...
${s}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
  ...
  async getLatestTagName(t) {
    const r = this.options, n = r.host == null || r.host === "github.com" ? (0, er.newUrlFromBase)(`${this.basePath}/latest`, this.baseUrl) : new ew.URL(`${this.computeGithubBasePath(`/repos/${r.owner}/${r.repo}/releases`)}/latest`, this.baseApiUrl);
    try {
...
const Ae = ce, Qi = At, rw = Iu, Rn = ze, Zi = se;
class nw extends Zi.Provider {
  /**
  ...
  async findBlockMapUrlsFromAssets(t, r, n) {
    ...
    if (s) {
      const l = n.replace(new RegExp(rw(r), "g"), t);
...
mi.KeygenProvider = iw;
var gi = {};
Object.defineProperty(gi, "__esModule", { value: !0 });
gi.PrivateGitHubProvider = void 0;
const Yt = ce, aw = Ee, ow = re, Ys = At, zs = ze, sw = wt, lw = se;
class cw extends sw.BaseGitHubProvider {
  constructor(t, r, n, i) {
  ...
  async getLatestVersion() {
    ...
    let o;
    try {
      o = (0, aw.load)(await this.httpRequest(a, this.configureHeaders("application/octet-stream"), t));
    } catch (s) {
  ...
  resolveFiles(t) {
    return (0, lw.getFileList)(t).map((r) => {
      const n = ow.posix.basename(r.url).replace(/ /g, "-"), i = t.assets.find((a) => a != null && a.name === n);
      if (i == null)
...
gi.PrivateGitHubProvider = cw;
Object.defineProperty(di, "__esModule", { value: !0 });
di.isUrlProbablySupportMultiRangeRequests = Fu;
di.createClient = mw;
const On = ce, uw = hi, Xs = tn, fw = wt, dw = pi, hw = mi, pw = gi;
function Fu(e) {
...
function mw(e, t, r) {
  ...
  switch (n) {
    case "github": {
      ...
      return a == null ? new fw.GitHubProvider(i, t, r) : new pw.PrivateGitHubProvider(i, t, a, r);
    }
    case "bitbucket":
      return new uw.BitbucketProvider(e, t, r);
    case "gitlab":
      return new dw.GitLabProvider(e, t, r);
    case "keygen":
      return new hw.KeygenProvider(e, t, r);
    case "s3":
    case "spaces":
...
function gw(e, t, r) {
  ...
  const c = i.get(l);
  let f = 0;
  const { checksumToOffset: d, checksumToOldSize: g } = yw(n.get(l), m.offset, r);
  let v = o.offset;
...
dr.copyData = xu;
const Pn = ce, vw = _t, ww = Vr, _w = qt, Qs = Buffer.from(`\r
\r
`);
var ut;
(function(e) {
  ...
  copyExistingData(t, r) {
    return new Promise((n, i) => {
      const a = () => {
        ...
        if (o.kind !== _w.OperationKind.COPY) {
...
vi.ProgressDifferentialDownloadCallbackTransform = bw;
Object.defineProperty(rn, "__esModule", { value: !0 });
rn.DifferentialDownloader = void 0;
const _r = ce, ra = Tt, Rw = _t, Ow = dr, Pw = At, In = qt, tl = yi, Iw = vi;
class Nw {
  ...
  async doDownloadFile(t, r) {
    ...
    const a = (0, Rw.createWriteStream)(this.options.newFile, { fd: i });
    await new Promise((o, s) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        m = new Iw.ProgressDifferentialDownloadCallbackTransform(D, this.options.cancellationToken, this.options.onProgress), l.push(m);
      }
      ...
      A.redirect = "manual", g = (S) => {
        ...
        if (x.kind === In.OperationKind.COPY) {
          m && m.beginFileCopy(), (0, Ow.copyData)(x, d, n, s, () => g(S));
          return;
        }
        ...
        ae.on("redirect", (W, $e, E) => {
          this.logger.info(`Redirect to ${Dw(E)}`), y = E, (0, _r.configureRequestUrl)(new Pw.URL(y), A), ae.followRedirect();
...
const $w = rn;
class Fw extends $w.DifferentialDownloader {
  download(t, r) {
    return this.doDownload(t, r);
  }
}
Ei.GenericDifferentialDownloader = Fw;
var St = {};
(function(e) {
...
const Te = ce, xw = Wr, Lw = Jn, Uw = Cl, je = Tt, kw = Ee, na = ai, He = re, Dt = bu, nl = en, Mw = fi, il = Ru, Bw = tn, ia = di, aa = Rl, jw = Ei, zt = St;
class to extends Uw.EventEmitter {
  /**
  ...
  constructor(t, r) {
    ...
    }), r == null ? (this.app = new Mw.ElectronAppAdapter(), this.httpExecutor = new il.ElectronHttpExecutor((a, o) => this.emit("login", a, o))) : (this.app = r, this.httpExecutor = null);
  ...
  setFeedURL(t) {
    ...
    let n;
    typeof t == "string" ? n = new Bw.GenericProvider({ provider: "generic", url: t }, this, {
      ...r,
  ...
  async loadUpdateConfig() {
    return this._appUpdateConfigPath == null && (this._appUpdateConfigPath = this.app.appUpdateConfigPath), (0, kw.load)(await (0, je.readFile)(this._appUpdateConfigPath, "utf-8"));
  }
  ...
  async executeDownload(t) {
    ...
    function s() {
      ...
      return T.toLowerCase().endsWith(`.${t.fileExtension.toLowerCase()}`) ? He.basename(T) : t.fileInfo.info.url;
    }
    const l = await this.getOrCreateDownloadHelper(), m = l.cacheDirForPendingUpdate;
    await (0, je.mkdir)(m, { recursive: !0 });
    const c = s();
    let f = He.join(m, c);
    const d = o == null ? null : He.join(m, `package-${a}${He.extname(o.path) || ".7z"}`), g = async (T) => {
      await l.setDownloadedFile(f, d, i, r, c, T), await t.done({
        ...i,
        downloadedFile: f
      });
      const D = He.join(m, "current.blockmap");
    ...
    try {
      await t.task(S, n, d, A), await (0, Te.retry)(() => (0, je.rename)(S, f), {
        retries: 60,
        interval: 500,
  ...
  async differentialDownloadInstaller(t, r, n, i, a) {
    try {
      ...
      const c = async (v, y) => {
        const A = He.join(y, "current.blockmap");
        await (0, je.outputFile)(A, (0, aa.gzipSync)(JSON.stringify(v)));
      }, f = async (v) => {
        const y = He.join(v, "current.blockmap");
        try {
          if (await (0, je.pathExists)(y))
            return JSON.parse((0, aa.gunzipSync)(await (0, je.readFile)(y)).toString());
        } catch (A) {
      ...
      return g == null && (g = await l(s[0])), await new jw.GenericDifferentialDownloader(t.info, this.httpExecutor, m).download(g, d), !1;
    } catch (o) {
...
const al = Kn, qw = gt;
class Gw extends qw.AppUpdater {
  constructor(t, r) {
...
const Xt = Tt, Vw = rn, Ww = Rl;
class Yw extends Vw.DifferentialDownloader {
  async download() {
    const t = this.blockAwareFileInfo, r = t.size, n = r - (t.blockMapSize + 4);
    this.fileMetadataBuffer = await this.readRemoteBytes(n, r - 1);
    const i = Uu(this.fileMetadataBuffer.slice(0, this.fileMetadataBuffer.length - 4));
    await this.doDownload(await zw(this.options.oldFile), i);
  }
}
nn.FileWithEmbeddedBlockMapDifferentialDownloader = Yw;
function Uu(e) {
...
const ol = ce, sl = Kn, Xw = Tt, Kw = _t, Ar = re, Jw = Ht, Qw = nn, Zw = se, ll = St;
class e_ extends Jw.BaseUpdater {
  constructor(t, r) {
    super(t, r);
  }
  isUpdaterActive() {
  ...
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, Zw.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "AppImage", ["rpm", "deb", "pacman"]);
    return this.executeDownload({
      ...
      task: async (i, a) => {
        ...
        (t.disableDifferentialDownload || await this.downloadDifferential(n, o, i, r, t)) && await this.httpExecutor.download(n.url, i, a), await (0, Xw.chmod)(i, 493);
      }
    });
  }
  async downloadDifferential(t, r, n, i, a) {
    try {
      ...
      return this.listenerCount(ll.DOWNLOAD_PROGRESS) > 0 && (o.onProgress = (s) => this.emit(ll.DOWNLOAD_PROGRESS, s)), await new Qw.FileWithEmbeddedBlockMapDifferentialDownloader(t.info, this.httpExecutor, o).download(), !1;
    } catch (o) {
...
kr.AppImageUpdater = e_;
var Mr = {}, hr = {};
Object.defineProperty(hr, "__esModule", { value: !0 });
hr.LinuxUpdater = void 0;
const t_ = Ht;
class r_ extends t_.BaseUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /**
...
const n_ = se, cl = St, i_ = hr;
class ro extends i_.LinuxUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, n_.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "deb", ["AppImage", "rpm", "pacman"]);
    return this.executeDownload({
      fileExtension: "deb",
      fileInfo: n,
      downloadUpdateOptions: t,
...
const ul = St, a_ = se, o_ = hr;
class no extends o_.LinuxUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
...
const fl = St, s_ = se, l_ = hr;
class io extends l_.LinuxUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
...
const dl = ce, oa = Tt, c_ = _t, hl = re, u_ = Qf, f_ = gt, d_ = se, pl = Kn, ml = Wr;
class h_ extends f_.AppUpdater {
  constructor(t, r) {
  ...
  async updateDownloaded(t, r) {
    ...
    return await new Promise((m, c) => {
      ...
      this.server.on("request", (v, y) => {
        ...
        const T = (0, c_.createReadStream)(i);
        T.on("error", (D) => {
          try {
            y.end();
          } catch (x) {
...
ao.verifySignature = m_;
const gl = ce, ku = Kn, p_ = Jn, El = re;
function Mu(e, t) {
...
const Nn = ce, yl = re, y_ = Ht, v_ = nn, vl = St, w_ = se, __ = Tt, A_ = ao, wl = At;
class T_ extends y_.BaseUpdater {
  constructor(t, r) {
    super(t, r), this._verifyUpdateCodeSignature = (n, i) => (0, A_.verifySignature)(n, i, this._logger);
  }
  /**
  ...
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, w_.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "exe");
    return this.executeDownload({
      fileExtension: "exe",
      downloadUpdateOptions: t,
      fileInfo: n,
  ...
  async differentialDownloadWebPackage(t, r, n, i) {
    ...
    try {
      ...
      this.listenerCount(vl.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (o) => this.emit(vl.DOWNLOAD_PROGRESS, o)), await new v_.FileWithEmbeddedBlockMapDifferentialDownloader(r, this.httpExecutor, a).download();
    } catch (a) {
...
const Bu = ke.dirname(Zf(import.meta.url));
process.env.APP_ROOT = ke.join(Bu, "..");
const Sa = process.env.VITE_DEV_SERVER_URL, V_ = ke.join(process.env.APP_ROOT, "dist-electron"), ju = ke.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = Sa ? ke.join(process.env.APP_ROOT, "public") : ju;
let qe;
const _l = "https://github.com/zerr0o/gemini-super-power/releases";
function Hu() {
  return Xn.getFocusedWindow() ?? qe ?? void 0;
}
function S_(e, t = "export") {
...
async function C_(e, t) {
  const r = S_(t);
  let n = ke.join(e, r), i = 2;
  for (; ; )
    try {
      await ed(n, td.F_OK), n = ke.join(e, `${r}-${i}`), i += 1;
    } catch {
...
function Vu() {
  return me = Gu(me.status, me.message), me.enabled ? (Tl || (Tl = !0, Ue.autoUpdater.on("checking-for-update", () => {
    rr = !0, nt({
      status: "checking",
      progress: null,
      message: "Checking for updates..."
    });
  }), Ue.autoUpdater.on("update-available", (e) => {
    nt({
      status: "available",
  ...
  })), Al || (Ue.autoUpdater.autoDownload = !0, Ue.autoUpdater.autoInstallOnAppQuit = !0, Ue.autoUpdater.allowPrerelease = !1, Al = !0, nt({
...
async function Wu() {
  if (!Vu() || rr || me.status === "downloading")
    return me;
  try {
    await Ue.autoUpdater.checkForUpdates();
  } catch (e) {
    rr = !1, nt({
      status: "error",
      progress: null,
...
function Yu() {
  qe = new Xn({
    ...
    icon: ke.join(process.env.VITE_PUBLIC, "icon.png"),
    webPreferences: {
      preload: ke.join(Bu, "preload.mjs")
    }
  }), qe.webContents.on("did-finish-load", () => {
    qe == null || qe.webContents.send("main-process-message", (/* @__PURE__ */ new Date()).toLocaleString()), qe && oo(qe);
  }), Sa ? qe.loadURL(Sa) : qe.loadFile(ke.join(ju, "index.html"));
}
...
Gr.handle("desktop:save-directory-files", async (e, t) => {
  ...
  if (i.canceled || i.filePaths.length === 0)
    return null;
  const a = await C_(i.filePaths[0], t.folderName);
  for (const o of t.files) {
    const s = ke.join(a, o.relativePath);
    await Pl(ke.dirname(s), { recursive: !0 }), await Ol(s, qu(o.contents, o.encoding));
  }
  return a;
});
pt.on("window-all-closed", () => {
  process.platform !== "darwin" && (pt.quit(), qe = null);
});
pt.on("activate", () => {
  Xn.getAllWindows().length === 0 && Yu();
});
pt.whenReady().then(async () => {
  Yu(), Vu(), me.enabled && setTimeout(() => {
    Wu();
  }, 1400);
});
export {
